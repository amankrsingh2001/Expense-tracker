  ...
  return (
    <div className="fixed inset-0 bg-white z-50 flex flex-col items-center justify-center transition-opacity duration-600 animate-fade-in">
      ...
      <div className="absolute w-full h-full overflow-hidden pointer-events-none">
        <div
          className="absolute -top-20 -left-20 w-40 h-40 bg-gray-50 rounded-full animate-pulse-slow"
          style={{ animationDelay: "0.2s" }}
        ></div>
        <div
          className="absolute top-1/4 -right-10 w-20 h-20 bg-gray-50 rounded-full animate-pulse-slow"
          style={{ animationDelay: "0.5s" }}
        ></div>
        <div
          className="absolute bottom-1/3 -left-10 w-24 h-24 bg-gray-50 rounded-full animate-pulse-slow"
